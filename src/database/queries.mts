 ...
 */
export async function makeFriends(x: string, y: string, datapath?: string): Promise<void> {
 ...
 * @returns Promise<void>
 */
export async function breakUpFriends(x: string, y: string, datapath?: string): Promise<void> {
  let DATABASE_PATH = 'assets/databaseJSON/database';
  if (datapath) {
    DATABASE_PATH = datapath;
  }
